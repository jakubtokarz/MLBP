...
public:
	enum Status
	{
		...
		Aborted      // There is no feasible solution due to time limits or memeory limits
	};
	...
	int BaBNodes() const { return m_bab_nodes; }  // get number of branch-&-bound nodes from last slove(...) call
